...
**[返回主页](../README.md)** | **[开始阅读](../chapters/)** | **[完整目录](./AISecOps_TOC.md)**

**适用范围**: 《AISecOps：AI 驱动的安全体系》全书
...
**中文**: 智能体
**定义**: 能自主规划、调用工具、执行多步任务，并依据每步结果决定下一步的 AI 系统；区别于单轮问答式的模型调用。
**译名约定**: 本书统一将 agent 译作"智能体"（安全智能体、编程智能体），**不译作"代理"**——"代理"在本书中一律指网络与安全语境下的 proxy（反向代理、住宅代理、出网代理）或软件代理组件（主机代理、备份代理）。
**自主程度**: 以 L0–L5 自主等级刻画，见 17.1
**相关章节**: 17.1　演进主线与自主等级, 17.2　Agentic 安全智能体架构, 17.3　AI for SecOps, 第18章　AI 系统安全
...
**相关章节**: 第13章 业务风控与反欺诈, 第17章　AI for Security
...
**相关章节**: 第6章　应用安全架构, 第7章　供应链安全

### Coding Agent

**中文**: 编程智能体
**定义**: 能读写代码库、调用工具链、执行命令的智能体（Claude Code、OpenAI Codex 一类），用于把安全动作嵌进研发流水线——PR 安全门禁、SAST 扫描修复复验、IaC 写时扫描、检测规则起草等七个挂载点。
**成熟度**: 当前成熟停靠点集中在 L2–L3；因改动代码库的爆炸半径大，人审 gate 不可省
**注意**: 本书讲的是"用编程智能体做安全"；编程智能体自身作为攻击面（提示注入、工具滥用、供应链投毒）的防御归第18章
**相关章节**: 17.8　编程智能体与研发安全, 第18章　AI 系统安全
...
**相关章节**: 第12章　红队实践, 第17章　AI for Security
...
**相关章节**: 第11章　安全运营, 第17章　AI for Security
...
**相关章节**: 第6章　应用安全架构, 第11章　安全运营, 第19章　安全领导力
...
- OWASP SAMM (软件成熟度模型)
  **相关章节**: 第6章　应用安全架构, 第18章　Security for AI
