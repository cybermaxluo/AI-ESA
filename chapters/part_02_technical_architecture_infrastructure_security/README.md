...
| 术语          | 英文                                         | 定义                                                               |
| ------------- | -------------------------------------------- | ------------------------------------------------------------------ |
| 零信任        | Zero Trust                                   | 安全架构范式，核心原则为"永不信任，持续验证"，参考 NIST SP 800-207 |
| 威胁建模      | Threat Modeling                              | 系统化识别安全威胁的方法，常用框架包括 STRIDE、PASTA、Attack Tree  |
| SDR           | Security Design Review                       | 安全设计评审，在系统设计阶段验证安全架构合理性的评审流程           |
| CSPM          | Cloud Security Posture Management            | 云安全态势管理，持续监控云配置合规性                               |
| CWPP          | Cloud Workload Protection Platform           | 云工作负载保护平台，提供运行时威胁检测                             |
| CIEM          | Cloud Infrastructure Entitlement Management  | 云基础设施权限管理，分析云权限风险                                 |
| CNAPP         | Cloud Native Application Protection Platform | 云原生应用保护平台，整合 CSPM/CWPP/CIEM 能力                       |
| SDL           | Security Development Lifecycle               | 安全开发生命周期，将安全活动嵌入软件开发全流程                     |
| SAST          | Static Application Security Testing          | 静态应用安全测试，通过源代码分析识别漏洞                           |
| DAST          | Dynamic Application Security Testing         | 动态应用安全测试，通过运行时扫描识别漏洞                           |
| SCA           | Software Composition Analysis                | 软件成分分析，识别开源组件漏洞与许可证风险                         |
| SBOM          | Software Bill of Materials                   | 软件物料清单，记录软件制品的依赖组件信息                           |
| SLSA          | Supply-chain Levels for Software Artifacts   | 软件制品供应链安全等级框架                                         |
| OPA           | Open Policy Agent                            | 开放策略代理，云原生策略引擎                                       |
| CIS Benchmark | -                                            | 互联网安全中心发布的安全配置基线标准                               |
