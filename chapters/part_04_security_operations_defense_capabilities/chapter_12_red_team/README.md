...
目标：理解红队战略价值、投资回报和治理模型
推荐顺序：

1. 本 README（执行摘要、学习目标、法律警示）
2. 12.1 红队战略与组织（使命、定位、成熟度）
3. 12.7 红队报告与价值输出（ROI 量化）
4. 12.8 实战案例（业务价值体现）

### 路径 2：红队建设者（Red Team Leaders）
...
4. 12.4 红队演练设计（流程建立）
5. 12.5 紫队协作（协同机制）
6. 12.7 红队报告与价值输出（价值交付）

### 路径 3：技术执行者（Penetration Testers、Red Team Members）
...
2. 12.2 红队方法论（了解攻击框架）
3. 12.5 紫队协作（重点学习）
4. 12.6 攻击模拟与 BAS（持续验证）
5. 12.8 实战案例（检测改进实践）

### 路径 5：业务协同者（BISO/GSBP）
...
2. 12.4 红队演练设计（业务协同）
3. 12.8 实战案例（业务场景）
4. 12.7 红队报告与价值输出（业务语言）

### 路径 6：合规审查者（GRC/Legal/Compliance）
...
1. 本 README（法律警示）
2. 12.1 红队战略与组织（治理结构）
3. 12.4 红队演练设计（RoE 和合规要求）
4. 12.7 红队报告与价值输出（证据治理）
