...
- SABSA 四层架构框架：本指南参考 SABSA 框架对经典六层进行四层化提炼——业务需求层（从业务目标出发梳理安全需求）、架构逻辑层（设计安全框架与防御策略）、工程技术层（以技术工具将架构方案落地）、运营服务层（运营工具平台，提供安全能力与服务）。通过此框架，构建从业务需求直达运营服务的安全体系，指导各安全域的能力建设与运营。

关键框架包括 TOGAF、SABSA（四层化提炼）、Zachman，用于建立架构视图与决策追溯能力。
...
- 资源：阶段 1 需要 1-2 名架构师全职投入，阶段 2-3 需要 GRC 分析师与 BISO 各 1 名
- 组织：需要高管支持委员会决策权威，以及业务部门配合 champions 选拔
- 常见误区：避免跳过 阶段 1 直接推工具，导致治理与业务脱节
...
| 术语               | 英文                                            | 定义                                                                                         |
| ------------------ | ----------------------------------------------- | -------------------------------------------------------------------------------------------- |
| 企业架构           | Enterprise Architecture (EA)                    | 将组织战略意图转化为可执行设计的系统化方法，涵盖业务、数据、应用、技术四层架构               |
| TOGAF              | The Open Group Architecture Framework           | 企业架构开发框架，提供 ADM（架构开发方法）循环与架构视图标准                                 |
| SABSA              | Sherwood Applied Business Security Architecture | 业务驱动的安全架构框架，本书采用四层化提炼（业务需求层、架构逻辑层、工程技术层、运营服务层） |
| GRC                | Governance, Risk & Compliance                   | 治理、风险、合规三位一体的管理框架，将战略转化为可执行控制                                   |
| BISO               | Business Information Security Officer           | 业务安全官，负责在业务部门嵌入安全能力，是安全与业务间的桥梁角色                             |
| 三道防线           | Three Lines of Defense                          | 风险治理模型——第一道防线：业务部门自查；第二道防线：安全团队监督；第三道防线：审计验证     |
| FAIR               | Factor Analysis of Information Risk             | 信息风险因素分析方法，用于将威胁转化为财务损失预期的风险量化模型                             |
| TPRM               | Third-Party Risk Management                     | 第三方风险管理，评估供应商与合作伙伴的安全风险                                               |
| ADR                | Architecture Decision Record                    | 架构决策记录，记录架构设计中的关键决策及其理由                                               |
| Security Champions | -                                               | 安全冠军项目，在研发团队中培养安全代言人，推动安全左移                                       |
