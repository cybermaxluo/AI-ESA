...
### [9.3 个人数据处理合规](./9.3_个人数据处理合规.md)
- 个人数据的定义与识别
- 处理的合法基础（GDPR 6 种 / LGPD 10 种）
- 数据保护影响评估（DPIA）
- 合法利益评估（LIA）
- 特殊类别数据的额外保护
- 儿童数据保护（年龄验证/父母同意）

### [9.4 数据主体权利管理](./9.4_数据主体权利管理.md)
- 8 项数据主体权利（GDPR）
...
### [9.6 Cookie 与追踪管理](./9.6_Cookie与追踪管理.md)
- Cookie 分类与法律要求
- 同意管理平台（CMP）架构
- IAB TCF 2.2 框架
- 智能同意收集与优化
...
### [9.7 供应商与第三方管理](./9.7_供应商与第三方管理.md)
- 数据处理协议（DPA）要素
- 供应商隐私风险评估
- 子处理者管理与通知
- 国际数据传输机制（SCC/BCR）
...
- 跨境治理（8.8）支持 GDPR 第5章合规（9.1）
- 审计日志（8.7）提供隐私事件取证（9.8）

与 第10章的协同：
- DLP 策略（10.3）防止个人数据泄露（9.8）
- 信息分类（10.1）与隐私分类（9.3）统一
- 内部威胁（10.4）检测未授权数据访问（9.4）
...
[← 上一章：第8章](../第08章_数据安全/) | [返回 Part 目录](../) | [下一章：第10章 →](../../第03部分_数据安全与隐私/第10章_信息保护与内部风险/)
