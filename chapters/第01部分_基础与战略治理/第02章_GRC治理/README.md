...
> 第2章 GRC - Governance, Risk & Compliance

---

## 章节定位

本章建立企业级治理、风险与合规 (GRC) 框架，为安全体系提供决策机制、风险管控与合规保障。GRC 的核心价值不在于"建体系"本身，而在于将分散的治理活动整合为统一视图，让风险决策可量化、合规状态可追溯、治理成效可衡量。
...
成熟度评估的价值在于：识别当前能力短板、确定改进优先级、设定阶段性目标、衡量投资效果。成熟度演进不可跨级——从 Level 1 直接跳到 Level 3 通常会失败，原因在于缺乏中间阶段积累的流程基础和组织能力。

### 风险量化方法

风险量化将定性风险判断转化为可比较、可决策的定量数据。
...
| 2.9  | 人员安全       | 入职筛选分级、雇佣条款与 NDA、纪律处理、终止后责任、远程工作制度面、事件报告（ISO A.6） |
| 2.10 | 物理与环境安全 | 分区与门禁、环境威胁与支持性设施、清桌清屏、场外资产、介质与处置、云原生组织的裁剪（ISO A.7） |

---

## 章节文件

- [2.0 执行摘要](./2.0_执行摘要.md)：本章核心要点与决策框架
- [2.1 GRC 治理框架](./2.1_GRC治理框架.md)

  - GRC 三支柱与成熟度模型
  - GRC 与业务战略对齐
  - GRC 组织架构设计
- [2.2 风险管理体系](./2.2_风险管理体系.md)

  - 风险管理生命周期
  - 风险量化方法 (FAIR/ALE)
  - 第三方风险管理 (TPRM)
  - 新兴风险 (AI/云/跨境数据)
- [2.3 合规管理框架](./2.3_合规管理框架.md)

  - 全球合规地图
  - 合规差距分析
  - 审计与认证流程
- [2.4 政策与标准体系](./2.4_政策与标准体系.md)

  - 政策框架设计
  - 控制措施库
  - 政策生命周期管理
- [2.5 GRC 平台与工具](./2.5_GRC平台与工具.md)

  - GRC 工具选型
  - 合规自动化
  - GRC 集成与数据流
- [2.6 治理例会与报告](./2.6_治理例会与报告体系.md)

  - 风险委员会
  - 高管风险报告
  - 董事会安全汇报
- [2.7 实战案例](./2.7_实战案例.md)

  - 跨国企业 GRC 一体化
  - ISO 27001 认证路径
  - 供应链风险治理
  - AI 治理框架
- [2.8 附录与模板](./2.8_附录与模板.md)

  - 风险登记册模板
  - 合规检查清单
  - 政策模板库
  - GRC KPI/KRI 体系
- [2.9 人员安全](./2.9_人员安全.md)

  - 入职前筛选的分级设计与法域边界
  - 雇佣条款、保密协议与纪律处理
  - 终止或变更后的责任、远程工作制度面
  - 安全事件报告渠道与安全团队自身的人员风险
- [2.10 物理与环境安全](./2.10_物理与环境安全.md)

  - 分区模型、门禁与访客、视频监控的隐私边界
  - 环境威胁、支持性设施与设备维护
  - 清桌清屏、场外资产与差旅设备
  - 存储介质与安全处置、云原生组织的 A.7 裁剪
...
第1章建立了企业架构到安全架构的顶层逻辑（见 1.1 企业安全架构三层模型）。第2章在此基础上深化战略层的治理机制：
...
| 后续章节                   | 依赖关系                                                         |
| -------------------------- | ---------------------------------------------------------------- |
| 第2部分(技术架构，第4章-7)   | 架构设计满足合规要求；风险评估指导技术选型；政策标准约束架构决策 |
| 第3部分(数据安全，第8章-10)  | GDPR/PIPL 等隐私法规要求；数据分类分级标准；跨境数据传输合规     |
| 第4部分(安全运营，第11章-13) | 事件响应的合规要求；风险监控与 KRI 指标；审计证据管理            |
| 第6部分(AI 安全，第17章-15)  | AI 治理框架；AI 风险评估；AI 伦理合规                            |
| 第7部分(组织卓越，第19章)    | GRC 团队组织设计；角色能力要求；培训与文化建设                   |
...
[← 上一章：第1章](../../第01部分_基础与战略治理/第01章_企业架构基础/) | [返回 Part 目录](../) | [下一章：第3章 →](../../第01部分_基础与战略治理/第03章_业务安全伙伴/)
