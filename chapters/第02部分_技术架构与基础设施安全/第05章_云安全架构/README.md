...
### 模块三　工作负载保护 (Workload Protection)

[5.4 云工作负载保护](./5.4_云工作负载保护.md)
...
### 模块四　云原生安全工具 (Cloud-Native Security Tools)

[5.6 云原生安全工具链](./5.6_云原生安全工具链.md)
...
[5.7 DevSecOps 实践](./5.7_DevSecOps实践.md)
...
### 模块五　云安全运营 (Cloud Security Operations)

[5.8 云安全运营](./5.8_云安全运营.md)
...
### 模块六　多云治理与实战 (Multi-Cloud Governance & Cases)

[5.9 多云治理](./5.9_多云治理.md)
...
| DLP | Data Loss Prevention | 数据防泄露，防止敏感数据泄露 |
...
本章按照 SABSA 四层架构框架组织内容，从治理框架与战略层出发，逐层向下覆盖架构逻辑、工程技术与运营服务，各层输出成为下一层的前提：
...
| 相关章节 | 关联内容 | 阅读建议 |
|---------|---------|---------|
| 第4章安全架构与工程 | 架构框架（SABSA/TOGAF）、架构设计原则、零信任模型 | 先读 第4章了解架构方法论 |
| 第6章应用安全架构 | API 安全、微服务安全、SDL 流程 | 结合 5.7 DevSecOps 阅读 |
| 第7章供应链安全 | SBOM 管理、CI/CD 安全、依赖管理 | 结合 5.7 DevSecOps 阅读 |
| 第8章数据安全 | 数据分类分级、加密策略、DSPM | 结合 5.5 云数据保护阅读 |
| 第11章安全运营 | SOC 架构、SIEM 集成、事件响应 | 结合 5.8 云安全运营阅读 |
| 第17章AI for Security | AI 驱动威胁检测、自动化响应 | 云安全运营 AI 化参考本章 |

---

## 导航

[← 上一章：第4章](../../第02部分_技术架构与基础设施安全/第04章_安全架构与工程/) | [返回 Part 目录](../../第02部分_技术架构与基础设施安全/) | [下一章：第6章 →](../../第02部分_技术架构与基础设施安全/第06章_应用安全架构/)
