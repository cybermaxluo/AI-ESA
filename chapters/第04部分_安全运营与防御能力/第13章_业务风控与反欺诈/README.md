...
| 章节                                      | 主题         | 核心内容                                                                      | AI/ML 应用             |
| ----------------------------------------- | ------------ | ----------------------------------------------------------------------------- | ---------------------- |
| [13.0](./13.0_执行摘要.md)          | 执行摘要     | 战略价值、投资回报、核心框架                                                  | -                      |
| [13.1](./13.1_业务安全体系概览.md) | 业务安全体系 | 四大支柱、组织架构、业务对齐                                                  | -                      |
| [13.2](./13.2_账号安全与反撞库.md)           | 账号安全     | 注册/登录安全、multi-factor authentication (MFA)、account takeover (ATO) 防护 | 异常检测、设备指纹     |
| [13.3](./13.3_交易风控与反欺诈.md)   | 交易风控     | 实时决策引擎、反欺诈、AML                                                     | GNN 团伙识别、风险评分 |
| [13.4](./13.4_内容安全与反作弊.md)           | 内容安全     | user-generated content (UGC) 审核、反垃圾、机器人检测                         | NLP/CV、多模态审核     |
| [13.5](./13.5_营销活动安全.md)          | 营销活动安全 | 薅羊毛防护、优惠券风控                                                        | 设备指纹、行为分析     |
| [13.6](./13.6_爬虫对抗与API安全.md)               | 爬虫对抗     | 爬虫识别、API 安全、rate limiting                                             | 行为分析、指纹识别     |
| [13.7](./13.7_风控决策引擎设计.md)         | 风控决策引擎 | 规则引擎、ML 模型、A/B 测试                                                   | 特征工程、模型选型     |
| [13.8](./13.8_业务安全实战案例.md)               | 实战案例     | 电商、金融、社交平台案例                                                      | 完整落地实践           |
...
| 章节                                                                                                            | 关系     | 连接点                                                                |
| --------------------------------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------- |
| [第3章](../../第01部分_基础与战略治理/第03章_业务安全伙伴/)                    | 战略承接 | business information security officer (BISO) 模式 → 业务安全团队协作 |
| [第6章](../../第02部分_技术架构与基础设施安全/第06章_应用安全架构/) | 技术补充 | security development lifecycle (SDL) → 业务逻辑漏洞防护              |
| [第8章](../../第03部分_数据安全与隐私/第08章_数据安全/)                                              | 数据保护 | 数据分类 → 爬虫防护、data loss prevention (DLP)                      |
| [第11章](../第11章_安全运营/)                                                        | 运营协同 | security operations center (SOC) → 业务安全告警联动                  |
| [第17章](../../第06部分_AI驱动的安全创新/第17章_AI驱动网络安全/)                                   | AI 赋能  | AI 技术 → 业务安全 AI 应用                                           |

---

## 前提知识

建议先学习以下章节：[第1章](../../第01部分_基础与战略治理/第01章_企业架构基础/)（理解企业架构全景）、[第6章](../../第02部分_技术架构与基础设施安全/第06章_应用安全架构/)（理解应用层安全基础）、[第8章](../../第03部分_数据安全与隐私/第08章_数据安全/)（理解数据安全与隐私保护）。
...
[← 上一章：第12章](../第12章_红队实践/) | 返回 Part 目录 | [下一章：第17章 →](../../第06部分_AI驱动的安全创新/第17章_AI驱动网络安全/)
